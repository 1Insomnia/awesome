...
local exit = create_button("", beautiful.red, beautiful.green.."C0",beautiful.green.."E0")
...
local volume_symbol = ""
local volume_muted_color = beautiful.white
local volume_unmuted_color = beautiful.red
local volume = create_button(volume_symbol, volume_unmuted_color, beautiful.green.."30", beautiful.white.."50")
...
local microphone_muted_color = beautiful.white
local microphone_unmuted_color = beautiful.white
local microphone = create_button(microphone_symbol, microphone_unmuted_color, beautiful.red.."60", beautiful.red.."80")
...
local music = create_button("", beautiful.white, beautiful.red.."90", beautiful.green.."B0")
...
awful.screen.connect_for_each_screen(function(s)
    ...
    s.mylayoutbox.forced_width  = wibar_height - dpi(5)
    s.mylayoutbox.forced_height = wibar_height - dpi(5)
